...
import boto3
import io
from myapp.ai3d.img2pointGenerator import generate_pointcloud
...
def handle_generator_img(request):
    if request.method == "POST":
        ...
        if uploaded_image:
            ...
            for x in tqdm(sampler.sample_batch_progressive(batch_size=1, model_kwargs=dict(images=[image_uploaded]))):
                samples = x
            ...
            upload_to_aws_s3(npz_buffer, user_id, object_key)
