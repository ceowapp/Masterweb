...
const fragmentRing = `
 ...
 class Artificial extends GTLFCustomLoader{
  ...
  addLight(){
    this.aLight = new THREE.DirectionalLight(0xffffff, 100.0);
    this.aLight.position.set(0, 3, 15);
...
(function () {
    function initAbstract() {
      var o2 = {
      container:  document.querySelector('.md-ai')
      };
       var mdSettings2 =
        [
          {
            path: '../static/src/assets/dataset/models/brain2/',
            mdName: 'scene.gltf',
            scale: 0.05,
            posX: -1,
            posY: 2,
