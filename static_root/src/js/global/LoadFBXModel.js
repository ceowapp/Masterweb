 ...
 * 
*/
 export default class FBXCustomLoader{
  constructor(settings) {
    ...
    addSplotLight() {
      const loader = new THREE.TextureLoader().setPath("../static/src/assets/global/textures/spotLight/");
        ...
        this.spotLight.position.set(-3, 2, -5);
  ...
  setMaterials(){
    ...
    addInstancedObjects() {
    const loader = new FBXLoader().setPath("../static/src/assets/dataset/models/diamond/");
  ...
  addSingleObject(settings) {
    return new Promise((resolve, reject) => {
      const loader = new FBXLoader().setPath(settings.path);
      loader.load(
        settings.mdName,
        (object) => {
  ...
  onMouseMove = function(e) {
    ...
    renderBase() {
      ...
      this.model.rotation.y += ( this.targetRotation - this.group.rotation.y ) * 0.01*time;
      time += 0.01;
      }
     // Stars Animation
