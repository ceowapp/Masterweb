...
*/
 ...
 class GTLFCustomLoader{
  ...
  setMaterials(){
    ...
    addInstancedObjects() {
    const loader = new OBJLoader().setPath("../static/src/assets/dataset/models/diamond/");
    ...
    addSingleObjects() {
      const loader = new OBJLoader().setPath("../static/src/assets/dataset/models/sphere/");
