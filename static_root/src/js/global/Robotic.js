...
const fragmentRing = `
 ...
 class Robotic extends GTLFCustomLoader{
...
(function () {
    function init() {
      var o = {
      container:  document.querySelector('.md-robotic')
      };
      var mdSettings =
        [
          {
            path: '../static/src/assets/dataset/models/robotic/',
            mdName: 's2wt_kamdo_industrial_divinities-transformed.glb',
            scale: 10,
            posX: 0,
            posY: -10,
            posZ: 5,
      ...
      var RB = new Robotic(o, mdSettings);
    }
