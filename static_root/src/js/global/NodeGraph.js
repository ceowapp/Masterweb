  const graph_container = document.querySelector("#node-graph-viz");
    var w = graph_container.clientWidth,
    h = graph_container.clientHeight,
    ctx = graph_container.getContext( '2d' ),
    opts = {
      range: 180,
      baseConnections: 3,
      addedConnections: 5,
...
(function () {
    ...
    if (document.readyState === "complete" || (document.readyState !== "loading" && !document.documentElement.doScroll)) {
        ...
        document.addEventListener("DOMContentLoaded", initG);
    }
})();
