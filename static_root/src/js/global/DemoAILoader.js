...
(function () {
      ...
      var mdSettings =
        [    
          {
            path: '../static/src/assets/dataset/models/ring/scene.gltf',
            scale: 40,
            posX: 0,
            posY: -3,
            posZ: -5,
          ...
          {
            path: '../static/src/assets/dataset/models/face/humanoid_robot_face.glb',
            scale: 30,
            posX: -2,
            posY: -8,
            posZ: -5,
          ...
          {
            path: '../static/src/assets/dataset/models/pointcloud/cyber_orb.glb',
            scale: 6,
            posX: 0,
            posY: -3,
            posZ: -5,
