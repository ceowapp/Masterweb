...
const fragmentRing = `
 ...
 class Abstract extends GTLFCustomLoader{
  ...
  addLight(){
    this.aLight = new THREE.DirectionalLight(0xffffff, 50.0);
...
(function () {
    function initAbstract() {
      var o2 = {
      container:  document.querySelector('.md-index-abstract')
      };
       var mdSettings2 =
        [
          {
            path: '../static/src/assets/dataset/models/abstract1/',
            mdName: 'scene.gltf',
            scale: 2.5,
            posX: 5,
            posY: -5,
      ...
      var AT = new Abstract(o2, mdSettings2);
    }
