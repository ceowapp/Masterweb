...
document.addEventListener('mousemove', ev => mousepos1 = getMousePos1(ev));

export default class ButtonCtrl1 extends EventEmitter {
    constructor(el) {
        super();
        // DOM elements
        // el: main button
    ...
    render() {
        ...
        const distanceMouseButton = calculateDistance(this.DOM.$el, mousepos1.x, mousepos1.y)-550;
        ...
        if ( distanceMouseButton < this.distanceToTrigger ) {
            ...
            x = (mousepos.x - (this.rect.left + this.rect.width/2))*.02;
            y = (mousepos.y - (this.rect.top + this.rect.height/2))*.02;
        }
