...
function setupWorld() {
    new THREE.TextureLoader().load("../static/src/lib/THREE.Terrain/demo/img/sky1.jpg", function(e) {
...
function setupDatGui() {
    var r = new Image();
    r.src = "../static/src/lib/THREE.Terrain/demo/img/heightmap.png";
    var e = new dat.GUI(), t = (e.domElement.id = "mainpanel", new function() {
        ...
        a.load("../static/src/lib/THREE.Terrain/demo/img/sand1.jpg", function(i) {
            ...
            var e = sand.clone();
            scene3.add(e), a.load("../static/src/lib/THREE.Terrain/demo/img/grass1.jpg", function(n) {
                a.load("../static/src/lib/THREE.Terrain/demo/img/stone1.jpg", function(t) {
                    a.load("../static/src/lib/THREE.Terrain/demo/img/snow1.jpg", function(e) {
        ...
        this["Sound Activate"] = function() {
            ...
            new THREE.GLTFLoader().load("../static/src/assets/dataset/models/gallery/scene.gltf", function(e) {
            ...
            0 < generatedModels.length && generatedModels.forEach(function(e) {
                e.material = t, new m.Soundsettings().addAudioFinder("../static/src/lib/THREEJS/examples/sounds/376737_Skullbeatz___Bad_Cat_Maste.mp3", e);
            });
        };
    ...
    var a = new function() {
        ...
        this.delayOffset = defaultSettings.delayOffset, this.after = function() {
            ...
            let i;
            "undefined" === n && (i = "../static/src/lib/THREEJS/examples/sounds/376737_Skullbeatz___Bad_Cat_Maste.mp3", 
        ...
        this.initWallGenerator = function(e, t, n) {
            ...
            document.addEventListener("mousedown", function(e) {
                ...
                D.y = 2 * -(e.clientY / window.innerHeight) + 1, Q.setFromCamera(D, P), 
                0 < (J = Q.intersectObjects(K)).length && (L < Z && (W[L] = J[0].point.clone(), 
                (e = new THREE.Mesh(new THREE.SphereGeometry(10, 100, 100), new THREE.MeshBasicMaterial({
                    color: "red"
                }))).position.copy(J[0].point), te.addObjScene(e), L++), L === Z) && (shape = new THREE.Shape(), 
            ...
            }, !1), K = [], Q = new THREE.Raycaster(), D = new THREE.Vector2(), 
            W = [], new THREE.Vector3(), L = 0, Z = 2, (z = new THREE.PlaneGeometry(2e3, 2e3)).rotateX(-Math.PI / 2), 
            (z = new THREE.Mesh(z, new THREE.MeshStandardMaterial({
                color: "green"
            }))).visible = !1, te.addObjScene(z), K.push(z)) : isInteractiveShape && (u = e, 
            ...
            z = new THREE.LineBasicMaterial({
                ...
                C.subVectors(S.position, H[0].point), v = !0);
            }, !1), window.addEventListener("mouseup", function(e) {
                isInteractiveShape && (controls.enableRotate = !0, S = null, v = !1);
            }, !1), window.addEventListener("mousemove", function(e) {
                isInteractiveShape && (b.x = e.clientX / window.innerWidth * 2 - 1, 
                b.y = 2 * -(e.clientY / window.innerHeight) + 1, 0 != H.length) && v && (R.ray.intersectPlane(p, M), 
                S.position.copy(M).add(C), g.geometry.dispose(), g.geometry = N(), 
                _());
            }, !1), R = new THREE.Raycaster(), b = new THREE.Vector2(), v = !1, 
            M = new THREE.Vector3(), Y = new THREE.Vector3(0, 1, 0), C = new THREE.Vector3(), 
            A = x = 0, function e() {
                x = .001 * Date.now(), requestAnimationFrame(e), R.setFromCamera(b, h), 
                w.forEach((e, t) => {
            ...
            var u, q, h, p, w, E, g, U, y, f, T, H, S, R, b, v, M, Y, C, x, A, V, X, P, J, K, Q, D, W, L, Z, z;
            function $() {
        ...
        function M(t, n, e) {
            ...
            new THREE.TextureLoader().setPath("../static/src/lib/THREEJS/examples/textures/")), r = [ "disturb.jpg", "colors.png", "uv_grid_opengl.jpg" ], s = {
                none: null
            };
            ...
            i.map = s["../static/src/lib/THREEJS/examples/textures/disturb.jpg"], 
            i.castShadow = !0, i.shadow.mapSize.width = 1024, i.shadow.mapSize.height = 1024, 
            i.shadow.camera.near = 1, i.shadow.camera.far = 10, i.shadow.focus = 1, 
            n.add(i), o = new THREE.SpotLightHelper(i), n.add(o);
            var e = new dat.GUI({
                id: "lightPanel"
            }), c = {
                map: s["disturb.jpg"],
        ...
        function I(t) {
            ...
            (audio1 = E(t.scene, "../static/src/lib/THREEJS/examples/sounds/concrete-footsteps-6752.mp3")).autoplay = !1, 
            audio1.pause();
        }
        function B(e) {
            ...
            (audio2 = E(e.scene, "../static/src/lib/THREEJS/examples/sounds/concrete-footsteps-6752.mp3")).autoplay = !1, 
            audio2.pause();
        }
        function F(e) {
            resetAudio();
            {
                ...
                const u = panel3.addFolder("States"), h = u.add(v, "state").options(i), p = (h.onChange(function() {
                    L(v.state, .5);
                }), panel3.addFolder("Emotes"));
                function d() {
                    g.removeEventListener("finished", d), L(v.state, .2);
                }
            ...
            (audio3 = E(e.scene, "../static/src/lib/THREEJS/examples/sounds/concrete-footsteps-6752.mp3")).autoplay = !1, 
            audio3.pause();
        }
        Promise.all([ new Promise(t => {
            e.load("../static/src/lib/THREEJS/examples/models/gltf/Soldier.glb", function(e) {
                t(e);
            });
        }), new Promise(t => {
            e.load("../static/src/lib/THREEJS/examples/models/gltf/Xbot.glb", function(e) {
                t(e);
            });
        }), new Promise((t, n) => {
            e.load("../static/src/lib/THREEJS/examples/models/gltf/RobotExpressive/RobotExpressive.glb", function(e) {
                t(e);
            }, void 0, function(e) {
                n(e);
            });
        }), new Promise((t, n) => {
            e.load("../static/src/assets/media/gltf/tracker/junk-yard-robot-boy/source/multiclip.gltf", function(e) {
                t(e);
            }, void 0, function(e) {
                n(e);
            });
        }), new Promise((t, n) => {
            e.load("../static/src/lib/THREEJS/examples/models/gltf/BoomBox.glb", function(e) {
                t(e);
            }, void 0, function(e) {
                n(e);
            });
                    ...
                    if (console.log("wall", e), e) {
                        {
                            ...
                            var n = scene2;
                            var i = fpsCamera;
                            var o = "../static/src/lib/THREEJS/examples/sounds/376737_Skullbeatz___Bad_Cat_Maste.mp3";
                            console.log("This func audioIsolator is triggered");
                            const a = new THREE.CubeTextureLoader().setPath("../static/src/lib/THREEJS/examples/textures/cube/SwedishRoyalCastle/").load([ "px.jpg", "nx.jpg", "py.jpg", "ny.jpg", "pz.jpg", "nz.jpg" ]), r = ((t = t.scene).position.x = e.position.x, 
        ...
        function L(e, t) {
            b = w, w = u[e], b !== w && b.fadeOut(t), w.reset().setEffectiveTimeScale(1).setEffectiveWeight(1).fadeIn(t).play();
        }
        ...
        activateAudio = e, b(), console.log("activateAudio", activateAudio), localStorage.setItem("activateAudio", e), 
    ...
    var h = n.addFolder("Audio Control"), p = h.add(s, "backgroundmusic", Object.keys(_)).onFinishChange(function() {
        activateAudio && (b(), w.setValue(defaultSettings.pitch), E.setValue(defaultSettings.delayVolume), 
...
function initLoadScene1(e) {
    ...
    i = new THREE.Scene(), scene1 = i.clone(), new THREE.OBJLoader().load("../static/src/lib/THREEJS/examples/models/obj/walt/WaltHead.obj", function(e) {
...
function initLoadScene2(e) {
    ...
    i.add(n), new THREE.LWOLoader().load("../static/src/lib/THREEJS/examples/models/lwo/Objects/LWO3/Demo.lwo", function(e) {
...
function initLoadScene3(e) {
    ...
    function R(t, n) {
        ...
        new TWEEN.Tween(this).to({}, 2 * n).onUpdate(v).start();
    }
    function b() {
        t.aspect = window.innerWidth / window.innerHeight, t.updateProjectionMatrix(), 
        rendererCSS3D.setSize(window.innerWidth, window.innerHeight), v();
    }
    function v() {
    ...
    i.maxDistance = 6e3, i.addEventListener("change", v), (l = document.getElementById("table")).addEventListener("pointerdown", function() {
        ...
        R(r.grid, 2e3);
    }), R(r.table, 2e3), window.addEventListener("resize", b), function e() {
        requestAnimationFrame(e);
        TWEEN.update();
        i.update();
    }();
...
function initLoadScene4(e) {
    ...
    let d = 0;
    {
        ...
        f.addEventListener("load", function() {
            ...
            g();
        }), f.src = "../static/src/lib/THREEJS/examples/textures/sprite.png";
        for (let e = 0; e < i; e++) {
            ...
            if (d || l) {
                ...
                if (!(!u && !h || p && w)) {
                    ...
                    if (n) {
                        ...
                        if (h && !w && 250 < i) {
                            var R = W.subdivideByImpact(l, F, k, 1, 2, 1.5), b = R.length;
                            for (let e = 0; e < b; e++) {
                                var v = s.getLinearVelocity(), M = s.getAngularVelocity(), C = R[e];
                                C.userData.velocity.set(v.x(), v.y(), v.z()), C.userData.angularVelocity.set(M.x(), M.y(), M.z()), 
                                O(C);
                            }
                            I[B++] = l, m.collided = !0;
                        }
    ...
    Ammo().then(function(e) {
        ...
        z = new Ammo.btTransform(), f = new Ammo.btVector3(0, 0, 0);
        {
            ...
            const n = function(e, t, n, i, o, a, r) {
                ...
                color: 16777215
            })), i = (n.receiveShadow = !0, d.load("../static/src/lib/THREEJS/examples/textures/grid.png", function(e) {
...
function initLoadScene8(e) {
    ...
    function d(e) {
        e = "../static/src/lib/THREEJS/examples/models/pdb/" + e;
        ...
        M.length = 0, r.load(e, function(e) {
            ...
            for (let e = 0; e < o.count; e++) {
                ...
                m.updateMatrix(), v.add(m), M.push(m);
            }
            ...
            for (let n = 0; n < f.count; n += 2) {
                ...
                var R = x.set(0, 1, 0).cross(C), b = Math.acos(A.set(0, 1, 0).dot(V.copy(C).normalize())), R = new THREE.Matrix4().makeRotationAxis(R.normalize(), b), b = (t.matrix.copy(R), 
                t.quaternion.setFromRotationMatrix(t.matrix), t.matrixAutoUpdate = !1, 
                t.updateMatrix(), v.add(t), M.push(t), new THREE.Object3D());
                b.position.copy(T), b.position.lerp(H, .5), b.matrix.copy(R), b.quaternion.setFromRotationMatrix(b.matrix), 
                b.matrixAutoUpdate = !1, b.updateMatrix(), (e = document.createElement("div")).className = "bond", 
                ...
                t.userData.bondLengthFull = 55 + S + "px", (t.userData.joint = b).add(t), 
                v.add(b), M.push(t);
            }
            z(D.vizType);
        });
    ...
    n = new THREE.Scene(), scene1 = n.clone(), v = new THREE.Object3D(), n.add(v), 
    rendererCSS3D = new THREE.CSS3DRenderer(), document.getElementById("container1").appendChild(rendererCSS3D.domElement), 
    (i = new THREE.TrackballControls(t, e.domElement)).rotateSpeed = .5, L.onload = function() {
        d(D.molecule);
    }, L.src = "../static/src/lib/THREEJS/examples/textures/sprites/ball.png", window.addEventListener("resize", l), 
...
function initLoadScene9(e) {
    ...
    function v() {
        ...
        g.KeyS && w.add(R().multiplyScalar(-t)), g.KeyA && w.add(b().multiplyScalar(-t)), 
        g.KeyD && w.add(b().multiplyScalar(t)), m && g.Space && (w.y = 15), H(n), 
        S(n), a.position.y <= -25 && (p.start.set(0, .35, 0), p.end.set(0, 1, 0), 
        p.radius = .35, a.position.copy(p.end), a.rotation.set(0, 0, 0));
        renderSceneSetup(o, a), requestAnimationFrame(v);
    }
    ...
    }), new THREE.GLTFLoader().setPath("../static/src/lib/THREEJS/examples/models/gltf/").load("collision-world.glb", e => {
